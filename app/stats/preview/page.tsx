  ...
  return (
    <header className="flex flex-col gap-3 px-1">
      <div className="rounded-lg border border-amber-400/30 bg-amber-400/10 px-3 py-2 text-sm text-amber-200">
        <strong className="font-semibold">Preview — mock data.</strong> These numbers are generated,
        not real traffic. This page shows how the live stats will look once data (including
        week-over-week trends and builds) has accumulated.
      </div>
      <div>
