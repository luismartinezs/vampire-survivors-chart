...
export const dlcClasses: Record<TDlc, { selected: string; unselected: string; card: { bg: string; border: string } }> = {
  base: {
    selected:
      "bg-base-300/60 text-base-950 hover:text-base-50 border border-base-500 hover:bg-base-400/50 focus:ring-2 focus:ring-base-500 focus:outline-none transition-colors duration-200 active:scale-95 shadow-sm hover:shadow-md ring-inset ring-base-900 ring-2 disabled:opacity-50 disabled:cursor-not-allowed aria-selected:bg-base-400/70",
    unselected:
  ...
  lotm: {
    selected:
      "bg-lotm-300/60 text-lotm-950 hover:text-lotm-50 border border-lotm-500 hover:bg-lotm-400/50 focus:ring-2 focus:ring-lotm-500 focus:outline-none transition-colors duration-200 active:scale-95 shadow-sm hover:shadow-md ring-inset ring-lotm-900 ring-2 disabled:opacity-50 disabled:cursor-not-allowed aria-selected:bg-lotm-400/70",
    unselected:
  ...
  todf: {
    selected:
      "bg-todf-300/60 text-todf-950 hover:text-todf-50 border border-todf-500 hover:bg-todf-400/50 focus:ring-2 focus:ring-todf-500 focus:outline-none transition-colors duration-200 active:scale-95 shadow-sm hover:shadow-md ring-inset ring-todf-900 ring-2 disabled:opacity-50 disabled:cursor-not-allowed aria-selected:bg-todf-400/70",
    unselected:
  ...
  og: {
    selected:
      "bg-og-300/60 text-og-950 hover:text-og-50 border border-og-500 hover:bg-og-400/50 focus:ring-2 focus:ring-og-500 focus:outline-none transition-colors duration-200 active:scale-95 shadow-sm hover:shadow-md ring-inset ring-og-900 ring-2 disabled:opacity-50 disabled:cursor-not-allowed aria-selected:bg-og-400/70",
    unselected:
  ...
  otc: {
    selected:
      "bg-otc-300/60 text-otc-950 hover:text-otc-50 border border-otc-500 hover:bg-otc-400/50 focus:ring-2 focus:ring-otc-500 focus:outline-none transition-colors duration-200 active:scale-95 shadow-sm hover:shadow-md ring-inset ring-otc-900 ring-2 disabled:opacity-50 disabled:cursor-not-allowed aria-selected:bg-otc-400/70",
    unselected:
