...
const _weapons = {
  ...mergeIntoNestedObjects(_baseWeapons, { evolved: false }),
  ...mergeIntoNestedObjects(_evolvedWeapons, { evolved: true }),
};

export const weapons = mergeIntoNestedObjects<typeof _weapons, { type: "weapon" }>(_weapons, {
